...
const Demo = () => {
  ...
  return (
    <section id="demo" className="py-20 bg-gradient-to-br from-coffee-500 to-coffee-600">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="text-white">
              <header className="mb-8">
                ...
                <p className="text-xl text-coffee-100 text-center lg:text-left">
              ...
              <div className="space-y-6">
                <article className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-coffee-100">Tailored to your hotel's specific needs</p>
                  </div>
                </article>
                ...
                <article className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-coffee-100">Quick overview of key features</p>
                  </div>
                </article>
                ...
                <article className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-coffee-100">Learn from hotel industry specialists</p>
                  </div>
                </article>
              </div>
            </div>
            ...
            <div className="bg-white rounded-3xl p-8 shadow-2xl">
              ...
              <form onSubmit={handleSubmit} className="space-y-6" noValidate>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    <label htmlFor="demo-email" className="block text-coffee-700 font-medium mb-2">
                      Email Address *
                    </label>
                    <input
                      type="email"
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <label htmlFor="demo-hotel" className="block text-coffee-700 font-medium mb-2">
                      Hotel Name *
                    </label>
                    <input
                      type="text"
                      ...
                      onChange={handleInputChange}
                      className={`w-full p-3 border rounded-xl focus:ring-2 focus:ring-coffee-500 focus:border-transparent outline-none transition-all ${
                        errors.hotel ? 'border-red-500' : 'border-coffee-200'
                      }`}
                  ...
                  <div>
                    <label htmlFor="demo-rooms" className="block text-coffee-700 font-medium mb-2">
                      Number of Rooms
                    </label>
                    <select
                      id="demo-rooms"
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <label htmlFor="demo-phone" className="block text-coffee-700 font-medium mb-2">
                      Phone Number
                    </label>
                    <input
                      type="tel"
                  ...
                  <div>
                    <label htmlFor="demo-time" className="block text-coffee-700 font-medium mb-2">
                      Preferred Time
                    </label>
                    <select
                      id="demo-time"
